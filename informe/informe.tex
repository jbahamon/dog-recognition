...
Las restantes imágenes no contienen perros y fueron extraidas aleatoriamente del
dataset caltech-101. Por otro lado, se utilizó un \emph{corpus} de 5000 imágenes
del dataset caltech-256 para generar las palabras visuales.
...
son imágenes de perros extraidas aleatoriamente del dataset Cats and Dogs.  El
resto, 700 imágenes, no contienen perros, y fueron extraidas aleatoriamente del
dataset caltech-101.  Se extrajeron 500 imágenes de perros y no-perros para
